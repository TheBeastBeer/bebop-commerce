/**
 * Originally from: https://github.com/remix-run/remix/blob/785d2e2657ccfeb5acee408923e833f24ec9ba14/packages/remix-express/server.ts
 */
import type {
  AppLoadContext,
  ServerBuild,
...
export function createRequestHandler({
  ...
  return async (
    ...
    try {
      ...
      // custom part, from: https://sergiodxa.com/tutorials/automatically-commit-session-on-remix
